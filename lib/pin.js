...
module.exports = class Pin {
   ...
   * CONSTANTS
   */
  static PATH()         { return '/sys/class/gpio'; }
  static DIR_IN()       { return 'in'; }
  static DIR_OUT()      { return 'out'; }
  static VALUE_UP()     { return '1'; }
  static VALUE_DOWN()   { return '0'; }
  static EDGE_NONE()    { return 'none'; }
  static EDGE_RISING()  { return 'rising'; }
  static EDGE_FALLING() { return 'falling'; }
  static EDGE_BOTH()    { return 'both'; }
  static BOUND()        { return [2, 27]; }
